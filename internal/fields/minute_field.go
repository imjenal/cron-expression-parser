...
var _ common.CronField = &MinuteField{}

func NewMinuteField(value string) common.CronField {
	return &MinuteField{
		Value:      value,
		StartRange: config.MinuteFieldType.Min,
		EndRange:   config.MinuteFieldType.Max,
	}
}

func (f *MinuteField) Validate() error {
...
func (f *MinuteField) Expand() ([]int, error) {
	if f.Value == "*" {
