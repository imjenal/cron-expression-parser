...
var _ common.CronField = &MonthField{}

func NewMonthField(value string) common.CronField {
	return &MonthField{
		Value:      value,
		StartRange: config.MonthFieldType.Min,
		EndRange:   config.MonthFieldType.Max,
	}
}
